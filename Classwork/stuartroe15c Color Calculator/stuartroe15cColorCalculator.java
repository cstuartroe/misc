 ...
 */
public class stuartroe15cColorCalculator extends JFrame
{
     ...
     */
    public stuartroe15cColorCalculator()
    {
        ...
        hexField.addActionListener(new ActionListener()
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                {
                    JOptionPane.showMessageDialog(stuartroe15cColorCalculator.this, "The text entered is not a valid hex code.");
                }
    ...
    private class ColorSliderPanel extends JPanel
    {
        ...
        public ColorSliderPanel(String _title)
        {
            ...
            slide.addChangeListener(new ChangeListener()
                ...
                {
                    stuartroe15cColorCalculator.this.resetDisplay();
                }
            });
        }
    ...
    private class SideListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            stuartroe15cColorCalculator.this.side = sideTo;
            stuartroe15cColorCalculator.this.setComponentPositions();
        }
    }
    ...
    {
        new stuartroe15cColorCalculator();
    }
}