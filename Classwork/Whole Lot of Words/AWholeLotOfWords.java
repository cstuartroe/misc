...
public class AWholeLotOfWords extends javax.swing.JFrame implements Runnable
{
    private JTextArea alfred;
    private boolean isSaved;
    private File elifAnt;
    
    public AWholeLotOfWords()
    {
        alfred = new JTextArea();
        //Figure out all the places to change this.
        isSaved = true;
        //where do we add our document listener?
        
        elifAnt = null;

        alfred.getDocument().addDocumentListener(new DocumentListener(){
            private void doIt()
            {
                isSaved = false;
                updateTitleBar(); 
    ...
    private boolean dontDie()
    {
        ...
        try
        {
            ...
            BufferedWriter buffy = new BufferedWriter(new FileWriter(elifAnt));
    ...
    private boolean itsAlive()
    {
        ...
        //TODO check to see if this is still correct.
    ...
    {
        javax.swing.SwingUtilities.invokeLater( new AWholeLotOfWords() );
    }
}